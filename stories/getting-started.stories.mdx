...
<h1>
  @pbe/react-yandex-maps <small>v{version}</small>
</h1>

`@pbe/react-yandex-maps` is a wrapper around Yandex.Maps API that allows you to
...
box), [see FAQ](?path=/story/faq--page) for more info.

## Core Principles

There are a few [core principles](?path=/story/core-principles--page) that are
forming the base of this library. It will be very helpful to keep those in mind,
...
[4.1]: ?path=/story/core-principles--page#modular-approach
[4.2]: ?path=/story/core-principles--page#controlled-and-uncontrolled-components
[4.3]:
  ?path=/story/core-principles--page#react-context-provider-and-consumer-components
